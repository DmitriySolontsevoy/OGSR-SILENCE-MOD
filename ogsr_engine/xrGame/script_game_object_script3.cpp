...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject>&& instance)
{
	return std::move(instance)
		...
		.def( "best_cover",   ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, float, const luabind::functor<bool>& ) ) ( &CScriptGameObject::best_cover ) )
		...
		.def( "ambush_cover", ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, const luabind::functor<bool>& ) ) ( &CScriptGameObject::ambush_cover ) )
		...
		.def( "angle_cover",  ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, float, const Fvector&, float, float, u32, const luabind::functor<bool>& ) ) ( &CScriptGameObject::angle_cover ) )
