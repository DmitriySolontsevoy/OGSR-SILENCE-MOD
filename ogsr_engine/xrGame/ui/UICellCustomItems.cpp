...
bool CUIWeaponCellItem::is_pointer() { return object()->PointerAttachable() && object()->IsPointerAttached(); }

bool CUIWeaponCellItem::is_foregrip() { return object()->ForegripAttachable() && object()->IsForegripAttached(); }
