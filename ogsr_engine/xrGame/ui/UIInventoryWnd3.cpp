...
void CUIInventoryWnd::ProcessPropertiesBoxClicked()
{
    if (UIPropertiesBox.GetClickedItem())
    {
        ...
        case INVENTORY_DETACH_POINTER_ADDON: DetachAddon(*(smart_cast<CWeapon*>(CurrentIItem()))->GetPointerName()); break;
        case INVENTORY_DETACH_FOREGRIP_ADDON: DetachAddon(*(smart_cast<CWeapon*>(CurrentIItem()))->GetForegripName()); break;
