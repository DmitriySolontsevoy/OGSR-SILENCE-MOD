...
float CCustomHelmet::GetDefHitTypeProtection(ALife::EHitType hit_type)
{
...
BOOL CCustomHelmet::BonePassBullet(int boneID)
{
...
u32	CCustomHelmet::ef_equipment_type	() const
{
