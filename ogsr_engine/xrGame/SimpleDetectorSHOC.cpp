...
BOOL CCustomDetectorSHOC::feel_touch_contact(CObject* O) { return (NULL != smart_cast<CCustomZone*>(O)); }
...
u32 CCustomDetectorSHOC::ef_detector_type() const { return (m_ef_detector_type); }
