...
float CEntityCondition::ApplyImmunityBoosts(float hit_power, ALife::EHitType hit_type)
{
    switch (hit_type)
    {
    case ALife::eHitTypeTelepatic: return hit_power * (1 - m_fPsychicImmunityBoostValue);
    case ALife::eHitTypeChemicalBurn: return hit_power * (1 - m_fChemicalImmunityBoostValue);
    case ALife::eHitTypeShock: return hit_power * (1 - m_fElectricImmunityBoostValue);
    case ALife::eHitTypeRadiation: return hit_power * (1 - m_fRadiationImmunityBoostValue);
    case ALife::eHitTypeBurn: return hit_power * (1 - m_fThermalImmunityBoostValue);
    default: return hit_power;
    }
}
